    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        className={cn(
          ...
          "bg-card rounded-2xl shadow-2xl border p-6",
...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn("flex flex-col-reverse sm:flex-row justify-end gap-3 mt-6", className)}
      {...props}
    />
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Close
      ...
      render={<Button variant="outline" className={cn("flex-1 sm:flex-none", className)} />}
      {...props}
    />
  )
}
